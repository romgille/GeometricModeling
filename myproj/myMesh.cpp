...
bool myMesh::triangulate(myFace *f)
{
	...
	myHalfedge *adjacent_halfedge = f->adjacent_halfedge;
	myHalfedge *actual_halfedge = adjacent_halfedge;
	...
	} while (actual_halfedge != adjacent_halfedge);
	...
	for (int i = 1; i < n - 2; ++i) {
		...
		OUT[i]->source = adjacent_halfedge->source;
